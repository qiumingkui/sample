...
import com.qiumingkui.sample.iwords.user.helper.PersonTestHelper;
...
public class PersonRepositoryTest {
	...
	public void save4Create() {
		aPerson4Admin = PersonTestHelper.buildPerson4AdminExample();
		aPerson4AdminId = aPerson4Admin.personId();
		personRepository.save(aPerson4Admin);

		aPerson4CommonUser = PersonTestHelper.buildPerson4CommonUserExample();
