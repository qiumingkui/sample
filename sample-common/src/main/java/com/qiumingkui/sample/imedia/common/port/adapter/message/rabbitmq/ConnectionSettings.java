 ...
 * information for the host, port, virtual host, and user.
 *
...
public class ConnectionSettings {
	...
	/**
	 * Answers a new ConnectionSettings with a specific host name and virtual
	 * host and remaining defaults.
	 * 
	 * @param aHostName
	 *            the String name of the host server
	 * @param aVirtualHost
	 *            the String name of the virtual host
	 * @return ConnectionSettings
	 */
	public static ConnectionSettings instance(String aHostName, String aVirtualHost) {
	 ...
	 *            the String name of the host server
	 * @param aPort
	 *            the int port number on the host server, or -1
	 * @param aVirtualHost
	 *            the String name of the virtual host
	 * @param aUsername
	 *            the String name of the user, or null
	 * @param aPassword
	 *            the String password of the user, or null
	 */
	public static ConnectionSettings instance(String aHostName, int aPort, String aVirtualHost, String aUsername,
			String aPassword) {
		return new ConnectionSettings(aHostName, aPort, aVirtualHost, aUsername, aPassword);
	}
	 ...
	 *            the String password of the user, or null
	 */
	protected ConnectionSettings(String aHostName, int aPort, String aVirtualHost, String aUsername, String aPassword) {
	 ...
	 * 
	 * @param aHostName
	 *            the String to set as my hostName
	 */
	private void setHostName(String aHostName) {
		AssertionUtil.assertArgumentNotEmpty(aHostName, "Host name must be provided.");
	...
	private void setVirtualHost(String aVirtualHost) {
		AssertionUtil.assertArgumentNotEmpty(aVirtualHost, "Virtual host must be provided.");
